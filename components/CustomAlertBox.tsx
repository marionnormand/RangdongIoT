...
const CustomAlertBox: React.FC<CustomAlertBoxProps> = ({ visible, message, onCancel, onConfirm,  showCancelButton = false, cancelButtonText = 'Cancel', confirmButtonText = 'Add' }) => {
  return (
    <Modal
      animationType="slide"
      transparent={true}
